...
//System.out.println("Inside Wsearch");
		List<JSONObject> list = new ArrayList<JSONObject>();
		String[] parts = search.split("\\s+");
		
		StringBuffer buffer = new StringBuffer();
		buffer.append("http://api.walmartlabs.com/v1/search?lsPublisherId=3266265&query=");
		...
		buffer.append("&format=xml&apiKey=htx2f2zpy2spz854nghw3k3u");
		// create HTTP Client
		...
		JSONObject bannerLinks = (JSONObject) xmlJSONObj.get("searchresponse");
		if(!(bannerLinks.isNull("items"))){
