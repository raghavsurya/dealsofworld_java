...
*/
	...
	public  List<JSONObject> helper(String catId) throws ClientProtocolException, IOException {
		//System.out.println("Inside WCatapi");
		
		StringBuffer buffer = new StringBuffer();
		buffer.append("http://api.walmartlabs.com/v1/feeds/specialbuy?format=xml&apiKey=htx2f2zpy2spz854nghw3k3u&lsPublisherId=3266265&categoryId=");
		buffer.append(catId);
		...
		JSONObject bannerLinks = (JSONObject) xmlJSONObj.get("root");
