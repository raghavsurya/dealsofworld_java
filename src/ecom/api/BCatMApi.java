...
/*	public static void main(String[] args){
	...
	*/
	...
	public List<JSONObject> helper(String catId) throws ClientProtocolException, IOException {
		...
		sb.append("http://api.bestbuy.com/beta/products/mostViewed(categoryId=");
		sb.append(catId);
		sb.append(")?apiKey=5rrt9gjbgkutaz4wngznx76y&lsPublisherId=3266265");
