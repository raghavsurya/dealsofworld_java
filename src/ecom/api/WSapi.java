...
/*		public static void main(String[] args){
	...
	public  List<JSONObject> helper() throws ClientProtocolException, IOException {
		System.out.println("Inside WSPapi");
		...
		HttpGet getRequest = new HttpGet("http://api.walmartlabs.com/v1/paginated/items?format=xml&apiKey=htx2f2zpy2spz854nghw3k3u&lsPublisherId=3266265&specialOffer=specialbuy");
		...
		JSONObject bannerLinks = (JSONObject) xmlJSONObj.get("itemsResponse");
