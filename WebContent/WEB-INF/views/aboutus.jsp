        ...
        <div class="container">
            <header class="page-header">
                <ol class="breadcrumb page-breadcrumb">
                    ...
                    <li class="active">About DealsOfWorld.com!</li>
                </ol>                
...
(adsbygoogle = window.adsbygoogle || []).push({});
                ...
                <div class="col-md-9">
					...
					<h2>About DealsOfWorld.com!</h2>
					<h3>Welcome to the DealsofWorld.com Daily Deals. We work round the clock to bring our users the best deals in the USA. Happy Savings!.</h3>
                    </div>
