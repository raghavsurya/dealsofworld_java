        ...
        <div class="container">
            <header class="page-header">
                <ol class="breadcrumb page-breadcrumb">
                    ...
                    <li class="active">Top Clearance Products</li>
                </ol>                
                ...
                <ul class="category-selections clearfix">
					...
					<select name="myselect" id="myselect" class="category-selections-select" onchange="this.form.submit()">
						<option selected value="41">Trending Now</option>
						<option value="42">Price : Lowest First</option>
						<option value="43">Price : Highest First</option>
						<option value="44">Percentage : Lowest First</option>
						<option value="45">Percentage : Highest First</option>
					</select>
					</form>
                    </li>
...
<c:forEach items="${clearance}" var="product">
                        <div class="col-md-3">
                            <div class="product ">
