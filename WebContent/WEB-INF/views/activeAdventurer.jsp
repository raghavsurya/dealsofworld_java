        ...
        <div class="container">
            <header class="page-header">
                <ol class="breadcrumb page-breadcrumb">
                    ...
                    <li class="active">Active Adventurer</li>
                </ol>                
                ...
                <ul class="category-selections clearfix">
					...
					<select name="myselect" id="myselect" class="category-selections-select" onchange="this.form.submit()">
						<option selected value="31">Trending Now</option>
						<option value="32">Price : Lowest First</option>
						<option value="33">Price : Highest First</option>
						<option value="34">Percentage : Lowest First</option>
						<option value="35">Percentage : Highest First</option>
					</select>
					</form>
                    </li>
...
<c:forEach items="${activeAdventurer}" var="product">
                        <div class="col-md-3">
                            <div class="product ">
