...
<ul class="nav navbar-nav">
                        <li class="dropdown yamm-fw"><a href="#">Deals<i class="drop-caret" data-toggle="dropdown"></i></a>
        ...
        <div class="container">
            <header class="page-header">
                <ol class="breadcrumb page-breadcrumb">
                    ...
                    <li class="active">${specialbuyCategoryID.categoryName}</li>
                </ol>                
                ...
                <ul class="category-selections clearfix">
					...
					<select name="myselect" id="myselect" class="category-selections-select" onchange="this.form.submit()">
						<option selected value="71">Trending Now</option>
						<option value="72">Price : Lowest First</option>
						<option value="73">Price : Highest First</option>
						<option value="74">Percentage : Lowest First</option>
						<option value="75">Percentage : Highest First</option>
					</select>
					<input type="hidden" name="categorySortID" value="${specialbuyCategoryID.categoryId}">					
					</form>
...
<c:forEach items="${specialbuyCategoryID.categoryList}" var="product">
                        <div class="col-md-3">
                            <div class="product ">
                                <ul class="product-labels"><c:if test="${product.percentage ge 30}"><li>${product.percentage}% off</li></c:if><c:if test="${product.percentage ge 50}"><li>hot</li></c:if></ul>
                                <div class="product-img-wrap">
                                    <img Height=180 Width=180 class="product-img-primary" src="${product.imgSrc}" alt="Image Alternative text" title="Image Title" />
                                    <img Height=180 Width=180 class="product-img-alt" src="${product.imgSrc}" alt="Image Alternative text" title="Image Title" />
                                </div>
                               <a target="_blank" class="product-link" href="${product.prodLink}" ></a>
                                <div class="product-caption">
                                	<h5>${product.vendor}</h5>
                                    <h5 class="product-caption-title">${product.title}</h5>

                                   <div class="product-caption-price"><span class="product-caption-price-old"><c:if test="${product.listPriceFlag}">${product.listPrice}</c:if></span><span class="product-caption-price-new"><c:if test="${product.offerAmtFlag}">${product.offerAmt}</c:if></span>
</div>
