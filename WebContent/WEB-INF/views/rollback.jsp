        ...
        <div class="container">
            <header class="page-header">
                <ol class="breadcrumb page-breadcrumb">
                    ...
                    <li class="active">Top Rollback Products</li>
                </ol>                
                ...
                <ul class="category-selections clearfix">
					...
					<select name="myselect" id="myselect" class="category-selections-select" onchange="this.form.submit()">
						<option selected value="51">Trending Now</option>
						<option value="52">Price : Lowest First</option>
						<option value="53">Price : Highest First</option>
						<option value="54">Percentage : Lowest First</option>
						<option value="55">Percentage : Highest First</option>
					</select>
					</form>
                    </li>
...
<c:forEach items="${rollback}" var="product">
                        <div class="col-md-3">
                            <div class="product ">
