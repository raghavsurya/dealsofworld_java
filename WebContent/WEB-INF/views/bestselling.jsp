                                    ...
                                    <div class="row row-eq-height row-col-border">
                                        <div class="col-md-2">
                                            ...
                                            <ul class="dropdown-menu-items-list">
                                                ...
                                                <li><a href="preorder">Top Preorder Products</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
        ...
        <div class="container">
            <header class="page-header">
                <ol class="breadcrumb page-breadcrumb">
                    ...
                    <li class="active">Top Bestselling Products</li>
                </ol>                
                ...
                <ul class="category-selections clearfix">
					...
					<select name="myselect" id="myselect" class="category-selections-select" onchange="this.form.submit()">
						<option selected value="21">Trending Now</option>
						<option value="22">Price : Lowest First</option>
						<option value="23">Price : Highest First</option>
						<option value="24">Percentage : Lowest First</option>
						<option value="25">Percentage : Highest First</option>
					</select>
					</form>
                    </li>
