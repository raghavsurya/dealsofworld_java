        ...
        <div class="container">
            <header class="page-header">
                <ol class="breadcrumb page-breadcrumb">
                    ...
                    <li class="active">${categoryID.categoryName}</li>
                </ol>                
                ...
                <ul class="category-selections clearfix">
					...
					<select name="myselect" id="myselect" class="category-selections-select" onchange="this.form.submit()">
						<option selected value="61">Trending Now</option>
						<option value="62">Price : Lowest First</option>
						<option value="63">Price : Highest First</option>
						<option value="64">Percentage : Lowest First</option>
						<option value="65">Percentage : Highest First</option>
					</select>
					<input type="hidden" name="categorySortID" value="${categoryID.categoryId}">					
					</form>
...
<c:forEach items="${categoryID.categoryList}" var="product">
                        <div class="col-md-3">
                            <div class="product ">
