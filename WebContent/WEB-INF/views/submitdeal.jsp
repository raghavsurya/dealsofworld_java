        ...
        <div class="container">
            <header class="page-header">
                <ol class="breadcrumb page-breadcrumb">
                    ...
                    <li class="active">Submit A Deal DealsOfWorld.com!</li>
                </ol>                
...
(adsbygoogle = window.adsbygoogle || []).push({});
                ...
                <div class="col-md-9">
                    <div class="row" data-gutter="15">
						<h2>Submit A Deal DealsOfWorld.com!</h2>
						<h3>Send a note to support@dealsofworld.com email with the deal information and your deal will be reviewed and after successful review it will be posted on our website.</h3>
						<h3>Thank you</h3>	
					</div>
