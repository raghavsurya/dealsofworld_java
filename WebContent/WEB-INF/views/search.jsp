        ...
        <div class="container">
            <header class="page-header">
                <ol class="breadcrumb page-breadcrumb">
                    ...
                    <li class="active">Search results for ${search.keyword}</li>
                </ol>                
                ...
                <ul class="category-selections clearfix">
					...
					<select name="myselect" id="myselect" class="category-selections-select" onchange="this.form.submit()">
						<option selected value="11">Trending Now</option>
						<option value="12">Price : Lowest First</option>
						<option value="13">Price : Highest First</option>
						<option value="14">Percentage : Lowest First</option>
						<option value="15">Percentage : Highest First</option>
					</select>
					<input type="hidden" name="searchFilter" value="${search.keyword}">
					</form>
...
<c:forEach items="${searchKeyword.keywordList}" var="product">
                        <div class="col-md-3">
                            <div class="product ">
